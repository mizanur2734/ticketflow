  ...
  return (
      <div className="py-2">
        <div className="relative z-50 flex items-center justify-between">
          ...
          <ul className="flex items-center hidden space-x-8 text-[18px] lg:flex">
            <li>
              <a
                href="/"
            ...
            <li className="ml-6">
                <button className="btn px-2 flex items-center gap-1 p-2 bg-gradient-to-r from-[#632EE3] to-[#9F62F2]
                 text-white rounded">
                  <IoMdAdd />
                  New Ticket
                </button>
