...
const Banner = ({ inProgress, resolved }) => {
  return (
    <div className="flex flex-col md:flex-row gap-6 md:gap-16 mt-6 md:mt-12 w-full">
      ...
      {/* LEFT CARD */}
      <div className="relative h-44 md:h-56 flex justify-center items-center rounded-xl bg-gradient-to-r from-[#632EE3] to-[#9F62F2] overflow-hidden shadow-lg">
      ...
      {/* RIGHT CARD */}
      <div className="relative h-44 md:h-56 flex justify-center items-center rounded-xl bg-gradient-to-r from-[#54CF68] to-[#00827A] overflow-hidden shadow-lg">
